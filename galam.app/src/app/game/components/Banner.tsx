        ...
        <div className="w-full h-186 pt-20 bg-[url('/images/game.png')] bg-cover">
          ...
          <div className="w-40 h-40 flex ml-50 gap-65">
            ...
            <div className="block mt-10 ">
               <button className="text-center ml-12 text-white w-50 border-1 rounded-3xl hover:shadow-xl/10 hover:shadow-white h-10 transition-transform duration-300 ease-out hover:scale-105">DOWNLOAD FOR PC</button>
               <button className="text-center mt-5 text-white border-1 rounded-3xl  hover:shadow-xl/10 hover:shadow-white w-80 h-10 transition-transform duration-300 ease-out hover:scale-105">DOWNLOAD FOR ANDROID</button>  
            </div>
            <img src="/images/locked.png" alt="lock" />
